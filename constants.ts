...
**PERSISTENT THREAT NAMING GUIDANCE (UPDATED):**
* The persistent threat should have a descriptive name that reflects its nature and role in the scenario. This name is primarily for internal tracking and may be referenced in narrative when appropriate, but the focus should be on the threat's behavior and impact rather than its label. Names should be evocative and specific to the scenario context.
`;
