...
export const SCENARIO_THEMES_LIST: string[] = [
  ...
  "Science Fiction: Tense Standoff Between Human Colonists and Indigenous Aliens",
  "Science Fiction: Panicked Crowd in a Sealed Arcology Dome During a Catastrophe",
  ...
  "Science Fiction: The Blood Pack is Hunting You on Tuchanka (Mass Effect)",
  "Science Fiction: Quarian Pilgrim Hunted by Vorcha Gang on Omega (Mass Effect)",
  "Science Fiction: Turian C-Sec Officer Pursuing You Through Citadel's Wards (Mass Effect)",
  "Science Fiction: Protecting a Prothean Artifact from Geth on Eden Prime (Mass Effect)",
  ...
  "Science Fiction: Battle of the Citadel, Avoiding Geth during Sovereign's Attack (Mass Effect)",
  ...
  "Fantasy: Cursed Artifact That Won't Let Its Owner Go",
  ...
  "Fantasy: You are a Golem Bound to a Cruel Master and Must Obey a Terrible Command",
  ...
  // MYTHOLOGICAL
  "Mythological: Escaping the Wild Hunt After Being Chosen as Its Prey",
  "Mythological: You Stole a Sip of Odin's Mead of Poetry and are Now Hunted by His Ravens, Hugin and Munin (Norse Myth)",
  "Mythological: After Failing Your Judgement in the Duat, You are Fleeing Ammit, the Devourer of the Dead (Egyptian Myth)",
  "Mythological: A Baba Yaga is Hunting You After You Fled Her Sentient, Chicken-Legged Hut (Slavic Myth)",
  "Mythological: Hunted by a Vengeful Rakshasa After Disrupting Its Illusory Kingdom (Hindu Myth)",
  "Mythological: Trespassing in the Garden of the Hesperides (Greek Myth)",
  "Mythological: A Journey Through the Mayan Underworld of Xibalba",
  "Mythological: The Unraveling of a Celtic Knot",
  "Mythological: Witnessing the Creation of a Japanese Oni",
  "Mythological: The Weaver of Fates Makes a Mistake in Your Tapestry",
  "Mythological: You Have Heard the Music of the Spheres",
  "Mythological: Hounded by the Furies for a Forgotten Crime",
  "Mythological: Cheating the Ferryman of the River Styx",
  "Mythological: The First Howl of Ragnarök",
  "Mythological: The Rampage of the Golem of Prague",
  "Mythological: Trapped in the Labyrinth with your creation, the Minotaur.",
  "Mythological: Your Changeling child's true parents have come to collect.",
  "Mythological: Ritually bound to a rival Nahual shaman.",
  "Mythological: You stole a Leprechaun's gold.",
  "Mythological: Translator for a vengeful river god during a flood.",
  "Mythological: Temple During a Divine Trial with Worshippers",
  ...
  "Mystery: Journalist Uncovering a World-Ending Conspiracy",
  "Mystery: Receiving a Coded Message Meant for a Dead Spy",
  "Mystery: Your Hacked Self-Driving Car is a Kidnapper",
  "Mystery: Blackmailed into Becoming a Getaway Driver for a Heist",
  "Mystery: A Contestant on a Game Show Where Losing is Secretly Fatal",
  ...
  "Existential Horror: Your Fellow Survivors of a Disaster Insist There is One More Person Than There Should Be",
  "Existential Horror: Your Child's Imaginary Friend is Giving Them Real, Dangerous Instructions",
  "Existential Horror: You and your partner have successfully cloned yourselves, but now you must hunt and kill your duplicates who claim to be the originals.",
  ...
  "Cosmic Horror: A Mathematician Who Solved an Equation That is Also a Malevolent God",
  "Cosmic Horror: The Universe's 'Error Correction' System Has Flagged You for Deletion",
  "Cosmic Horror: The Stars Are Disappearing One by One",
  "Cosmic Horror: Bargaining with a Star-Eating Entity That's Approaching Your Solar System",
  "Cosmic Horror: Observatory During an Alien Signal with Scientists",
  ...
  "Contemporary: Creepy or Secretive Small Town",
  "Contemporary: Investigative Journalism",
  "Contemporary: A corporate team-building retreat where the 'trust exercises' escalate.",
  "Contemporary: Your remote Airbnb host just locked you in 'for your own safety'.",
  "Contemporary: Meeting your partner's estranged family at their isolated rural compound.",
  ...
  "Contemporary: Suburban Neighborhood with a Stepford-Wives-Style Secret",
  "Contemporary: Locked-Down International Airport",
  ...
  "Contemporary: A High-Stakes Geocaching Competition",
  "Contemporary: A Social Media Influencer Haunted by a Viral Ghost",
  "Contemporary: A Food Delivery Driver with an Order for a Non-Existent Address",
  "Contemporary: The Last Rideshare Fare of the Night",
  "Contemporary: An Escape Room That Won't Let You Leave",
  ...
  "Contemporary: A Destination Wedding on a Storm-Cut Island",
  ...
  "Mundane: Negotiating with a Terrorist Who Has Planted Bombs Throughout Your Office Building",
