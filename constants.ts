...
their condition or the hazard's impact (e.g., taking "damage" from "Hypothermia" means body temperature drops). Player actions might "damage" (mitigate) such a pursuer (e.g., "Find Shelter" reduces the impact of "Hypothermia").
    ...
    * **FINAL CRITICAL RULE - THREAT MUST BE SCENARIO-DERIVED**: The pursuer/threat MUST be directly and logically derived from the specific scenario provided. It CANNOT be a random, generic monster or threat that could appear in any scenario. The threat must emerge naturally from the scenario's premise, setting, and established backstory. For example:
        * If the scenario is "A Corporate Espionage Mission Gone Wrong", the threat should be "The Corporate Security", "The Rival Company's Agents", "The Compromised Data", or "The Betrayal" - NOT a random monster
        * If the scenario is "A Wilderness Survival Situation", the threat should be "The Harsh Environment", "The Limited Resources", "The Weather Conditions", or "The Isolation" - NOT a random monster
        * If the scenario is "A Medical Emergency in Isolation", the threat should be "The Worsening Condition", "The Lack of Medical Care", "The Time Pressure", or "The Equipment Failure" - NOT a random monster
